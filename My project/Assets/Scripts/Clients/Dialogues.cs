        ...
        public static Dictionary<string, string[]> Phrases =
            new Dictionary<string, string[]>
            {
                ...
                {"Tyler", new []
                {
                    ...
                    "Кстати, вы услуги <link=хоронит своего двойника><color=red>двойников</link></color> не предлагаете? " +
                    ...
                    "Ну и наведите шуму, чтоб фанатки прям <link=плакальщицы><color=red>ревели</link></color> на похоронах.",
